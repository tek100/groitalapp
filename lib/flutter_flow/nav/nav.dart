...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AnimateWidget.routeName,
          path: AnimateWidget.routePath,
          builder: (context, params) => AnimateWidget(),
        ),
        FFRoute(
          name: NotificationPagessWidget.routeName,
          path: NotificationPagessWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'notificationPagess')
              : NavBarPage(
                  initialPage: 'notificationPagess',
                  page: NotificationPagessWidget(),
                ),
        ),
        FFRoute(
          name: DataCollectionPageWidget.routeName,
          path: DataCollectionPageWidget.routePath,
          builder: (context, params) => DataCollectionPageWidget(
            dataCollectionName: params.getParam(
              'dataCollectionName',
              ParamType.String,
            ),
          ),
